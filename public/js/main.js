...
function setupMobileMenu() {
  ...
  mobileMenuPara.classList.add('nhsuk-header__navigation-title'); // create a label for the dropdown

  const mobileMenuLabel = document.createElement('span');
  mobileMenuLabel.innerHTML = 'More topics';
  mobileMenuLabel.setAttribute('id', 'label-navigation'); // create a close button for the dropdown
  ...
  mobileMenuCloseButton.setAttribute('aria-label', 'Close'); // add label and close to dropdown
